    ...
    resources: {
      ...
      ru: {
        translation: {
          ...
          step3_subtext_success:
            "Ваша электронная витрина была обновлена ​​в соответствии с загруженным файлом. Если не все строки были загружены, это означает, что эти продукты отсутствуют в нашей базе данных. Мы будем проанализируем результат и добавим их в ближайшем будущем.",
